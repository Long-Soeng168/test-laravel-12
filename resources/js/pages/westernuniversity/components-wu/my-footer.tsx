    ...
    return (
        <>
            ...
            <footer className="w-full">
                <div className="mx-auto max-w-screen-2xl px-4 sm:px-10 md:px-20">
                    <div className="flex gap-20 py-14">
                        <div className="mb-0 flex-1">
                            <a href="#" className="flex w-32 justify-center lg:justify-start">
                                <img src="assets/demo-images/logo-WU.png" />
                            </a>
                        </div>
                        <div className="flex flex-wrap justify-between gap-10">
                            {/* Contact Us */}
                            <div className="w-full text-center lg:w-[48%] lg:text-left">
                                <h4 className="font-noto-san-extra-light text-xl font-medium text-black">Contact us</h4>
                                <div className="mt-2 mb-6 w-full rounded-full bg-gray-300">
                                    <div className="h-[1px] w-[20%] rounded-full bg-[#e31c24]"></div>
                                </div>
                                <ul className="text-gray-600 transition-all mb-4 duration-500">
                                    <li className="mb-4 flex items-center gap-2">
                                        <img src="assets/demo-images/call.png" className="w-6" /> +855 96 8000 111
                                    </li>
                                    <li className="mb-4 flex items-center gap-2">
                                        <img src="assets/demo-images/location.png" className="w-6" />
                                        No 145, St.608 Corner St.313, Sangkat Boeng Kork II, Khan Toul Kork, Phnom Penh, Cambodia
                                    </li>
                                    <li className="flex items-center gap-2">
                                        <img src="assets/demo-images/mail.png" className="w-6" />
                            ...
                            {/* Newsletter */}
                            <div className="w-full text-center lg:w-[48%] lg:text-left">
                                <h4 className="font-noto-san-extra-light text-lg font-medium text-black">Newsletter</h4>
                                <div className="mt-2 mb-6 w-full rounded-full bg-gray-300">
                                    <div className="h-[1px] w-[20%] rounded-full bg-[#e31c24]"></div>
                                </div>
                                <div className="mx-auto w-full max-w-sm lg:mx-0">
                                    <p className="mb-3 text-gray-600">Enter your email to get the latest university news, events, and updates.</p>
                                    <div className="flex">
                                        <input type="email" placeholder="Your e-mail" className="w-full rounded-l-md border p-2 focus:outline-none" />
                                        <button className="bg-[#e31c24] px-4 py-2 text-white">Subscribe</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className=" bg-[#2c318a] py-2">
                        <div className="flex mx-auto max-w-screen-2xl px-4 sm:px-10 md:px-20 flex-col items-center justify-center lg:flex-row lg:justify-between">
                            <span className="text-sm text-white">
                            Copyright © Western University 2003 - 2025 Developed by: Cloud Cambodia
                            </span>
