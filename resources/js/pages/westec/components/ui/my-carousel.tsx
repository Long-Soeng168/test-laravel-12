...
export default function Carousel({ slides, autoplayDelay = 5000, autoplay = true }: CarouselProps) {
  ...
  }, [autoplay, autoplayDelay, slides.length, isPaused])

  // Reset pause state after user inactivity
  useEffect(() => {
    if (!isPaused) return
