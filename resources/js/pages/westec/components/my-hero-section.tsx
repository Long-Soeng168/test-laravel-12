...
export function MyHeroSection() {
    return (
        <>
            <div
                className="relative mx-auto mt-1 flex aspect-[21/9] w-full flex-col"
                style={{ backgroundImage: "url('assets/images/79.png')", backgroundSize: 'cover', backgroundPosition: 'center' }}
            >
                <img src="assets/images/logoBgBlue.png" className="absolute top-10 right-10 w-36" />

                <div className="grid w-full grid-cols-1 gap-4 p-10 lg:grid-cols-2">
                    {/* Left Section - Grows to push the right section down */}
                    ...
                    {/* Right Section - Aligned at Bottom */}
                        ...
                        <div className="flex flex-wrap justify-end gap-4">
                            {[
                                ...
                                <Link
                                    key={index}
                                    href="#"
                                    className="size-25 w-35  border bg-gray-800 p-2 text-center transition-all duration-500 hover:scale-110 hover:shadow-lg"
                                >
                                    <div className="flex flex-col items-center">
                                        <img src={`assets/images/${item.img}`} className="h-12 w-12 object-cover" alt="No image" />
                                    </div>
